...
type BowlingServiceClient interface {
	Bowl(ctx context.Context, in *Throw, opts ...grpc.CallOption) (*PlayerScoreStack, error)
}
...
func (c *bowlingServiceClient) Bowl(ctx context.Context, in *Throw, opts ...grpc.CallOption) (*PlayerScoreStack, error) {
	out := new(PlayerScoreStack)
...
type BowlingServiceServer interface {
	Bowl(context.Context, *Throw) (*PlayerScoreStack, error)
}
...
var fileDescriptor0 = []byte{
	...
	0xc1, 0x04, 0x36, 0x04, 0xc2, 0x31, 0x0a, 0xe7, 0xe2, 0x83, 0xba, 0x27, 0x38, 0xb5, 0xa8, 0x2c,
	0x33, 0x39, 0x55, 0xc8, 0x95, 0x8b, 0x05, 0x24, 0x22, 0x24, 0xae, 0x87, 0xe1, 0x0d, 0xb0, 0x5b,
	0xa5, 0x94, 0x30, 0x25, 0xd0, 0x9d, 0xa1, 0xc4, 0x90, 0xc4, 0x06, 0xf6, 0xb3, 0x31, 0x20, 0x00,
	0x00, 0xff, 0xff, 0xb9, 0xa2, 0x00, 0x99, 0x0d, 0x01, 0x00, 0x00,
}
